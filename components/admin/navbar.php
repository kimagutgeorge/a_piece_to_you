<div class="nav-bar">
        ...
        <?php if($_GET["p"] == 'view-product' || $_GET["p"] == 'add-product' || $_GET["p"] == 'adminshop' || $_GET["p"] == 'add-product-category' || $_GET["p"] == 'orders'){?><li><a href="?p=add-product-category" <?php if($_GET["p"] == 'add-product-category'){?> class="row active" <?php }else{?> class="row text-secondary" <?php } ?>><div class="col-2"><i class="fa-solid fa-plus"></i></div><div class="col-10">Add Category</div></a></li><?php }?>
        <?php if($_GET["p"] == 'view-product' || $_GET["p"] == 'add-product' || $_GET["p"] == 'adminshop' || $_GET["p"] == 'add-product-category' || $_GET["p"] == 'orders'){?><li><a href="?p=add-product" <?php if($_GET["p"] == 'add-product'){?> class="row active" <?php }else{?> class="row text-secondary" <?php } ?>><div class="col-2"><i class="fa-solid fa-plus"></i></div><div class="col-10">Add Product</div></a></li><?php }?>
        <?php if($_GET["p"] == 'view-product' || $_GET["p"] == 'add-product' || $_GET["p"] == 'adminshop' || $_GET["p"] == 'add-product-category' || $_GET["p"] == 'orders'){?><li><a href="?p=orders" <?php if($_GET["p"] == 'orders'){?> class="row active" <?php }else{?> class="row text-secondary" <?php } ?>><div class="col-2"><i class="fa-solid fa-shopping-cart"></i></div><div class="col-10">Orders</div></a></li><?php }?>
