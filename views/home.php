         ...
         <!-- programs -->
          ...
          <div class="home-events hero-84 seven-vh">
            ...
            <div class="row four-vh">
                <div class="custom-four" style="margin-top:0px !important;">
                <div class="custom-twelve cal-header">
                ...
                <div id="calendar" class="calendar custom-twelve"></div>
                </div>
                    
                </div>
                <div class="custom-eight row" id="home_events">
                    <!-- insert data here -->
                </div>
            </div>
        </div>
